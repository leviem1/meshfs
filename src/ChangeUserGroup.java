...
/**
 *
 * The ChangeUserGroup is a window responsible for letting users change their group
 * membership.
 *
 * @author Mark Hedrick
 * @version 1.0.0
...
class ChangeUserGroup extends JFrame {
    ...
    private ChangeUserGroup(String userAccount, String serverAddress, int port) {
