...
class UserAccountOptions extends JFrame {
  ...
  private void initComponents() {
    ...
    //======== dialogPane ========
    {
      ...
      titleLbl2.setFont(
          new Font("Arial", titleLbl2.getFont().getStyle(), titleLbl2.getFont().getSize() + 9));
      ...
      //======== buttonBar ========
      {
        ...
        closeBtn.setFont(
            new Font("Arial", closeBtn.getFont().getStyle(), closeBtn.getFont().getSize() + 1));
        buttonBar.add(
            closeBtn,
      ...
      deleteAccount.setFont(
          new Font(
              "Arial", deleteAccount.getFont().getStyle(), deleteAccount.getFont().getSize() + 1));

      //---- changePasswordBtn ----
      changePasswordBtn.setText("Change Password");
      changePasswordBtn.setFont(
          new Font(
              "Arial",
              changePasswordBtn.getFont().getStyle(),
              changePasswordBtn.getFont().getSize() + 1));
                  ...
                  dialogPaneLayout
                      ...
                      .addGroup(
                          dialogPaneLayout
                              .createParallelGroup()
                              .addComponent(
                                  titleLbl2, GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
                              .addComponent(
                                  titleLbl,
          ...
          dialogPaneLayout
              ...
              .addGroup(
                  dialogPaneLayout
                      ...
                      .addComponent(
                          buttonBar, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)));
    }
