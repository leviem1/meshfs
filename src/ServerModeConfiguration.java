...
public class ServerModeConfiguration extends JFrame {
    ...
    private void initComponents() {
        ...
        label3 = new JLabel();
        label4 = new JLabel();
        numStripes = new JTextField();
        label5 = new JLabel();
        numStripeCopies = new JTextField();
        label6 = new JLabel();
        numWhole = new JTextField();
        label7 = new JLabel();
        minSpace = new JTextField();
        label8 = new JLabel();
    ...
    private JTextField numStripes;
    private JLabel label5;
    private JTextField numStripeCopies;
    private JLabel label6;
    private JTextField numWhole;
    private JLabel label7;
    private JTextField minSpace;
